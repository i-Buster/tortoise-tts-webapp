...
def mainFun(args_text, args_voice, args_preset):
    print('Converting text to voice... Please wait.....')
    if __name__ == '__main__' or __name__ == 'tortoise.do_tts':
        ...
        selected_voices = args_voice.split(',')
        for k, selected_voice in enumerate(selected_voices):
            ...
            gen, dbg_state = tts.tts_with_preset(args_text, k=args.candidates, voice_samples=voice_samples, conditioning_latents=conditioning_latents,
                                    preset=args_preset, use_deterministic_seed=args.seed, return_deterministic_state=True, cvvp_amount=args.cvvp_amount)
